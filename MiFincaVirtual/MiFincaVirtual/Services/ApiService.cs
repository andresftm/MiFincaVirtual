namespace MiFincaVirtual.Services
{
    ...
    {
        /// <summary> Metodo para evaluar la conectividad a internet.</summary>
        /// <returns> Un Objeto indicando si se pudo o no establecer la conexión.</returns>
        public async Task<Response> CheckConnection()
        {
            if (!CrossConnectivity.Current.IsConnected)
            {
                ...
                {
                    IsSuccess = false,
                    Message = Languages.Touroninternet,
                };
            }
        ...
        public async Task<Response> GetList<T>(string urlBase, string prefix, int id, string controller,
                    string tokenType, string accessToken)
        {
            try
            {
